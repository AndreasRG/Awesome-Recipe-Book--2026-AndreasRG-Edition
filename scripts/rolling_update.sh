...
# Update node-exporter (non-critical)
echo "[INFO] Updating node-exporter..."
docker compose -f docker-compose.app.yml up -d --force-recreate node-exporter-app
echo "[INFO] node-exporter updated."
