...
# Therefore, this is just for template for azure. I did the same with DB VM, but i have a seperate file that
# actually installs the DB and Patroni, so this is just for the VM creation part. 
